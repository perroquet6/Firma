public class Firma {
	...
	public void wydrukListyPrac(){
		...
		for (int i = 0; i < lista.iloscPrac; i++) {
			if(czyUrzednik(i)){
				System.out.println( i++ + ", " + lista.tablicaPracownikow[i].nazwisko + ", " + "Urzêdnik, " + lista.tablicaPracownikow[i].etat);
			}
			else{
				System.out.println(i++ + ", " + lista.tablicaPracownikow[i].nazwisko + ", " + "Robotnik, " + lista.tablicaPracownikow[i].etat);
			}
	...
	public void wydrukListyU(){
		...
		for (int i = 0; i < lista.iloscPrac; i++) {
			if(czyUrzednik(i)){
				System.out.println( i++ + ", " + lista.tablicaPracownikow[i].nazwisko + ", " + lista.tablicaPracownikow[i].etat);
			}
		}
	}
	...
	public void wydrukListyPlac(){
		...
		for (int i = 0; i < lista.iloscPrac; i++) {
			if(czyUrzednik(i)){
				System.out.println( i++ + ", " + lista.tablicaPracownikow[i].nazwisko + ", " + "Urzêdnik, " + lista.tablicaPracownikow[i].etat + lista.tablicaPracownikow[i].wyplata());
			}
			else{
				System.out.println(i++ + ", " + lista.tablicaPracownikow[i].nazwisko + ", " + "Robotnik, " + lista.tablicaPracownikow[i].etat + lista.tablicaPracownikow[i].wyplata());
			}
